...
export const UserProvider: React.FC<UserProviderProps> = ({children}) => {
    ...
    useEffect(() => {
        console.log("[UserContext] useEffect mount, token from localStorage:", localStorage.getItem("sessionToken"));
    }, []);

    const setConnectionState = (isConnected: boolean, token: string) => {
        console.log("[UserContext] setConnectionState called with:", {isConnected, token});
